...
export default function ChatHistory({
  ...
  if (history.length === 0 && !hasAttachments) {
    return (
      <div className="flex flex-col h-full md:mt-0 pb-44 md:pb-40 w-full justify-end items-center bg-white">
        <div className="flex flex-col items-center md:items-start md:max-w-[600px] w-full px-4">
          <p className="text-black text-lg font-base py-4">
            Bienvenido a tu nuevo espacio de trabajo.
          </p>
          {!user || user.role !== "default" ? (
            <p className="w-full items-center text-black text-lg font-base flex flex-col md:flex-row gap-x-1">
              Para comenzar,{" "}
              <span
